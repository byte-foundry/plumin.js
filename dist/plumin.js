...
var check = __webpack_require__(1);
var encode = __webpack_require__(6).encode;
var sizeOf = __webpack_require__(6).sizeOf;
/**
...
exports.SizeC = exports.PointC = undefined;
...
exports.mulScalar2D = mulScalar2D;
exports.arcToCubicBezier = arcToCubicBezier;

var _immutable = __webpack_require__(31);

var PointC = exports.PointC = (0, _immutable.Record)({
	x: 0,
	y: 0
});

var SizeC = exports.SizeC = (0, _immutable.Record)({
	width: 0,
	height: 0
});
...
function arcToCubicBezier(a, b, t1, t2) {
	...
	var EPrime1 = new PointC({
		x: -major * Math.sin(eta1),
		y: minor * Math.cos(eta1)
	});
	var EPrime2 = new PointC({
...
var bbox = __webpack_require__(14);
...
var _linear = __webpack_require__(3);
...
var Outline = function () {
	function Outline() {
		...
		if (svg) {
			...
			_commands.forEach(function (_ref2) {
				var _ref3 = _slicedToArray(_ref2, 1),
				    svgItem = _ref3[0];

				_this.children.push(new _Path2.default({ svg: svgItem }));
			});
		} else if (paths) {
			this.children = paths;
		}
	...
	_createClass(Outline, [{
		key: 'insertChildren',
		value: function insertChildren(index, items) {
			var children = [].concat(_toConsumableArray(this.children));

			children.splice.apply(children, [index, 0].concat(_toConsumableArray(items)));
		...
		value: function getSVGData() {
			var aPath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { commands: [] };

			var path = {
				commands: [].concat(_toConsumableArray(aPath.commands))
			};
		...
		key: 'combineTo',
		value: function combineTo(outline) {
			/*
   ...
   */
		...
		key: 'scale2D',
		value: function scale2D(vector, center) {
		...
		value: function scale(_scale, center) {
			return this.scale2D(new _linear.PointC({
				x: _scale,
				y: _scale
			}), center);
		}
		...
		key: 'rotate',
		value: function rotate(theta, center) {
			var children = this.children.map(function (child) {
		...
		key: 'skew',
		value: function skew(vector, center) {
			var children = this.children.map(function (child) {
		...
		key: 'interpolate',
		value: function interpolate(outline0, outline1, coef) {
			var paths = [];

			if (outline0.children.length === outline1.children.length) {
				for (var i = 0; i < outline0.children.length; i++) {
					...
					paths.push(outline0.children[i].interpolate(outline1.children[i], coef));
				}
			}
...
var _Outline = __webpack_require__(7);

var _Outline2 = _interopRequireDefault(_Outline);

var _OutlineGroup = __webpack_require__(30);

var _OutlineGroup2 = _interopRequireDefault(_OutlineGroup);
...
var Glyph = function () {
	function Glyph(_ref) {
		var unicode = _ref.unicode,
		    ...
		    outlines = _ref.outlines,
		    components = _ref.components,
		    anchors = _ref.anchors,
		    parentAnchors = _ref.parentAnchors,
		    subset = _ref.subset;
	...
	_createClass(Glyph, [{
		key: 'addOutline',
		value: function addOutline(child) {
			var outlines = [].concat(_toConsumableArray(this.outlines));
		...
		key: 'setOutlines',
		value: function setOutlines(outlines) {
			return new Glyph({
				unicode: this.ot.unicode,
				name: this.name,
				xMin: this.ot.xMin,
		...
		key: 'addAnchor',
		value: function addAnchor(item) {
			this.anchors.push(item);
			return item;
		}
	}, {
		key: 'addAnchors',
		value: function addAnchors(anchors) {
		...
		key: 'addParentAnchor',
		value: function addParentAnchor(item) {
		...
		value: function getOTCommands() {
			...
			this.outlines.forEach(function (outline) {
				...
				(_path$commands = path.commands).push.apply(_path$commands, _toConsumableArray(outline.getOTCommands().commands));
			});

			this.components.forEach(function (component) {
				var _path$commands2;

				(_path$commands2 = path.commands).push.apply(_path$commands2, _toConsumableArray(component.getOTCommands().commands));
			});
		...
		key: 'scale2D',
		value: function scale2D(vector, center) {
			var outlines = this.outlines.map(function (child) {
				return child.scale2D(vector, center);
			});

			var components = this.components.map(function (child) {
				return child.scale2D(vector, center);
			});
  	...
  	*/
		...
		key: 'interpolate',
		value: function interpolate(glyph0, glyph1, coef) {
			...
			if (glyph0.outlines.length === glyph1.outlines.length) {
				var outlines0 = glyph0.outlines;
				var outlines1 = glyph1.outlines;

				for (var i = 0; i < glyph0.outlines.length; i++) {
					outlines.push(_Outline2.default.interpolate(outlines0[i], outlines1[i], coef));
				}
			}
			...
			if (glyph0.components.length === glyph1.components.length) {
				var components0 = glyph0.components;
				var components1 = glyph1.components;

				for (var _i = 0; _i < glyph0.outlines.length; _i++) {
					if (components0[_i] instanceof _Outline2.default && components1[_i] instanceof _Outline2.default) {
						components.push(_Outline2.default.interpolate(components0[_i], components1[_i], coef));
					} else if (components0[_i] instanceof _OutlineGroup2.default && components1[_i] instanceof _OutlineGroup2.default) {
						components.push(_OutlineGroup2.default.interpolate(components0[_i], components1[_i], coef));
					}
				}
			}
...
var Node = function () {
	...
	_createClass(Node, [{
		...
		value: function set(label, value) {
			switch (label) {
				case 'x':
					{
						if (typeof value === 'number') {
							return new Node(this._point.merge({ x: value }), this._handleIn, this._handleOut);
						} else {
				...
				case 'y':
					{
						if (typeof value === 'number') {
							return new Node(this._point.merge({ y: value }), this._handleIn, this._handleOut);
						} else {
				...
				case 'point':
					{
						if (value instanceof _linear.PointC) {
							return new Node(value, this._handleIn, this._handleOut);
						} else {
				...
				case 'handleIn':
					{
						if (value instanceof _linear.PointC) {
							return new Node(this._point, value, this._handleOut);
						} else {
				...
				case 'handleOut':
					{
						if (value instanceof _linear.PointC) {
							return new Node(this._point, this._handleIn, value);
						} else {
		...
		value: function applyMatrix(matrix) {
			var point = (0, _linear.transform2D)(matrix, this._point);
			var handleIn = this._handleIn ? (0, _linear.transform2D)(matrix, this._handleIn) : null;
			var handleOut = this._handleOut ? (0, _linear.transform2D)(matrix, this._handleOut) : null;
		...
		value: function rotate(theta) {
			var center = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new _linear.PointC({ x: 0, y: 0 });

			var phi = Math.PI * theta / 180;
			var preRotate = [1, 0, 0, 1, -center.x, -center.y];
			var rotate = [Math.cos(phi), -Math.sin(phi), Math.sin(phi), Math.cos(phi), 0, 0];
			var postRotate = [1, 0, 0, 1, center.x, center.y];

			var matrix = (0, _linear.matrixMul)((0, _linear.matrixMul)(preRotate, rotate), postRotate);
		...
		key: 'translate',
		value: function translate(vector) {
			var matrix = [1, 0, 0, 1, vector.x, vector.y];

			return this.applyMatrix(matrix);
		}
	}, {
		key: 'scale2D',
		value: function scale2D(vector) {
			var center = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new _linear.PointC({ x: 0, y: 0 });

			var preScale = [1, 0, 0, 1, -center.x, -center.y];
			var scale = [vector.x, 0, 0, vector.y, 0, 0];
			var postScale = [1, 0, 0, 1, center.x, center.y];

			var matrix = (0, _linear.matrixMul)(postScale, (0, _linear.matrixMul)(scale, preScale));
		...
		key: 'skew',
		value: function skew(vector) {
			var center = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new _linear.PointC({ x: 0, y: 0 });

			var preSkew = [1, 0, 0, 1, -center.x, -center.y];
			var skew = [vector.x, 0, 0, vector.y, 0, 0];
			var postSkew = [1, 0, 0, 1, center.x, center.y];

			var matrix = (0, _linear.matrixMul)(postSkew, (0, _linear.matrixMul)(skew, preSkew));
...
var Path = function () {
	function Path() {
		...
		var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { segments: [], svg: undefined, closed: false },
		...
		if (svg) {
			...
			_commands.forEach(function (_ref2) {
				var _ref3 = _slicedToArray(_ref2, 4),
				    name = _ref3[2],
				    coordsUntrimmed = _ref3[3];

				var coords = coordsUntrimmed.trim();

				switch (name.toUpperCase()) {
					case 'M':
						{
							var _coords$split$map = coords.split(/[,\s]+/).map(parseFloat),
							    _coords$split$map2 = _slicedToArray(_coords$split$map, 2),
							    x = _coords$split$map2[0],
							    y = _coords$split$map2[1];

							var tempPath = _this.moveTo(new _linear.PointC({ x: x, y: y }));

							_this.nodes = tempPath.nodes;
							return;
						}
					case 'L':
						{
							var _coords$split$map3 = coords.split(/[,\s]+/).map(parseFloat),
							    _coords$split$map4 = _slicedToArray(_coords$split$map3, 2),
							    _x2 = _coords$split$map4[0],
							    _y = _coords$split$map4[1];

							var _tempPath = _this.lineTo(new _linear.PointC({
								x: _x2,
								y: _y
							}));

							_this.nodes = _tempPath.nodes;
							return;
						}
					case 'Z':
						{
							var _tempPath2 = _this.closePath();

							_this.closed = _tempPath2.closed;
							_this.nodes = _tempPath2.nodes;
							return;
						}
					case 'C':
						{
							var regexpCurve = /([0-9]+)[,\s]+([0-9]+)/g;
							var points = [];
							var resultCurve = regexpCurve.exec(coords);
							...
							var _points$map = points.map(function (item) {
								var _item$0$split$map = item[0].split(/[,\s]+/).map(parseFloat),
								    _item$0$split$map2 = _slicedToArray(_item$0$split$map, 2),
								    x = _item$0$split$map2[0],
								    y = _item$0$split$map2[1];

								return new _linear.PointC({
									x: x,
									y: y
								});
							}),
							...
							var _tempPath3 = _this.curveTo({
								c1: c1,
								c2: c2,
								c3: c3
							});

							_this.nodes = _tempPath3.nodes;
							return;
						}
					case 'Q':
						{
							var _regexpCurve = /([0-9]+)[,\s]+([0-9]+)/g;
							var _points = [];
							var _resultCurve = _regexpCurve.exec(coords);

							while (_resultCurve) {
								_points.push(_resultCurve);
								_resultCurve = _regexpCurve.exec(coords);
							}

							var _points$map3 = _points.map(function (item) {
								var _item$0$split$map3 = item[0].split(/[,\s]+/).map(parseFloat),
								    _item$0$split$map4 = _slicedToArray(_item$0$split$map3, 2),
								    x = _item$0$split$map4[0],
								    y = _item$0$split$map4[1];
							    ...
							    _points$map4 = _slicedToArray(_points$map3, 2),
							    _c = _points$map4[0],
							    _c2 = _points$map4[1];

							var _tempPath4 = _this.quadTo({
								c1: _c,
								c2: _c2
							});

							_this.nodes = _tempPath4.nodes;
							return;
						}
					default:
						{
			...
			var nodes = segments.map(function (segment) {
				if (segment instanceof _Node2.default) {
					return segment;
				} else {
					return new _Node2.default(new _linear.PointC(segment));
				}
			});
	...
	_createClass(Path, [{
		...
		value: function addNode(node) {
			var nodes = [].concat(_toConsumableArray(this.nodes));
		...
		value: function addNodes(nodes) {
			var newNodes = [].concat(_toConsumableArray(this.nodes));

			nodes.push.apply(nodes, _toConsumableArray(newNodes));
			return new Path({
				segments: newNodes,
				closed: this.closed
			});
		...
		value: function insertNodes(index, nodes) {
			...
			newNodes.splice.apply(newNodes, [index, 0].concat(_toConsumableArray(nodes)));
			return new Path({
				segments: newNodes,
				closed: this.closed
			});
		...
		value: function moveTo(point) {
			return this.addNode(new _Node2.default(point));
		}
	}, {
		key: 'lineTo',
		...
		key: 'curveTo',
		value: function curveTo(_ref4) {
			var c1 = _ref4.c1,
			    c2 = _ref4.c2,
			    c3 = _ref4.c3;

			var newPath = this.removeNode(this.nodes.length - 1);
			var nodes = [].concat(_toConsumableArray(newPath.nodes));

			if (this.lastNode) {
				var node = this.lastNode.set('handleOut', c1);

				nodes.push(node);
			}

			nodes.push(new _Node2.default(c3, c2));
		...
		value: function quadTo(_ref5) {
			...
			if (this.lastNode) {
				var node = this.lastNode.set('handleOut', (0, _linear.add2D)(this.lastNode._point, (0, _linear.mulScalar2D)(2 / 3, (0, _linear.subtract2D)(c1, this.lastNode._point))));

				nodes.push(node);
			}
			nodes.push(new _Node2.default(c2, (0, _linear.add2D)(c2, (0, _linear.mulScalar2D)(2 / 3, (0, _linear.subtract2D)(c1, c2)))));
		...
		value: function reverse() {
			var nodes = [].concat(_toConsumableArray(this.nodes)).reverse().map(function (node) {
				return new _Node2.default(node._point, node._handleOut, node._handleIn);
			});
		...
		key: 'updateData',
		value: function updateData(data, toSimple, toBezier) {
			var _data$commands;

			var _ref6 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : { reverse: false, matrix: [1, 0, 0, 1, 0, 0] },
			    reverse = _ref6.reverse,
			    _ref6$matrix = _ref6.matrix,
			    matrix = _ref6$matrix === undefined ? [1, 0, 0, 1, 0, 0] : _ref6$matrix;
			...
			var start = (0, _linear.transform2D)(matrix, curves[reverse ? length - 1 : 0]['point' + (reverse ? 2 : 1)]);

			(_data$commands = data.commands).push.apply(_data$commands, _toConsumableArray(toSimple('M', Math.round(start.x) || 0, Math.round(start.y) || 0)));

			for (var i = -1, l = curves.length; ++i < l;) {
				var curve = curves[reverse ? l - 1 - i : i];
				var end = (0, _linear.transform2D)(matrix, curve['point' + (reverse ? 1 : 2)]);

				if (!curve.handle1 && !curve.handle2 || curve.handle1 === null && curve.handle2 === null) {
					var _data$commands2;

					(_data$commands2 = data.commands).push.apply(_data$commands2, _toConsumableArray(toSimple('L', Math.round(end.x) || 0, Math.round(end.y) || 0)));
				} else if (curve && curve.handle1 && curve.handle2) {
					//to please flow
					var handle2 = curve.handle2;
					var ctrl1 = (0, _linear.transform2D)(matrix, curve.handle1);
					var ctrl2 = (0, _linear.transform2D)(matrix, handle2);

					if (reverse) {
						var _data$commands3;

						(_data$commands3 = data.commands).push.apply(_data$commands3, _toConsumableArray(toBezier('C', Math.round(ctrl2.x) || 0, Math.round(ctrl2.y) || 0, Math.round(ctrl1.x) || 0, Math.round(ctrl1.y) || 0, Math.round(end.x) || 0, Math.round(end.y) || 0)));
					} else {
						var _data$commands4;

						(_data$commands4 = data.commands).push.apply(_data$commands4, _toConsumableArray(toBezier('C', Math.round(ctrl1.x) || 0, Math.round(ctrl1.y) || 0, Math.round(ctrl2.x) || 0, Math.round(ctrl2.y) || 0, Math.round(end.x) || 0, Math.round(end.y) || 0)));
					}
				}
			}
			...
			if (this.closed) {
				...
				(_data$commands5 = data.commands).push.apply(_data$commands5, _toConsumableArray(toSimple('Z')));
			}
		...
		key: 'getOTCommands',
		value: function getOTCommands(data) {
			return this.updateData(data, function toSimple() {
				return [{
					type: arguments[0],
					x: arguments[1],
					y: arguments[2]
		...
		key: 'getSVGData',
		value: function getSVGData(data) {
			return this.updateData(data, function toSimple() {
				return arguments;
			}, function toBezier() {
				return arguments;
		...
		key: 'interpolate',
		value: function interpolate(path) {
			return path;
		}
	}, {
		key: 'firstNode',
		...
		get: function get() {
			...
			this.nodes.forEach(function (node, index) {
				...
				if (_this2.nodes.length - 1 > index || _this2.closed && _this2.nodes.length - 2 > index || _this2.closed && _this2.firstNode && _this2.lastNode && (_this2.firstNode.x !== _this2.lastNode.x || _this2.firstNode.y !== _this2.lastNode.y)) {
					...
					if (_this2.firstNode && _this2.nodes.length - 1 === index && _this2.nodes[0]) {
						newCurve.handle2 = _this2.firstNode._handleIn;
						newCurve.point2 = _this2.firstNode._point;
					}
		...
		key: 'Rectangle',
		value: function Rectangle(_ref7) {
			var point = _ref7.point,
			    size = _ref7.size;

			var topLeft = point;
			var topRight = (0, _linear.add2D)(point, new _linear.PointC({
				x: size.width,
				y: 0
			}));
			var bottomRight = (0, _linear.add2D)(point, new _linear.PointC({
				x: size.width,
				y: size.height
			}));
			var bottomLeft = (0, _linear.add2D)(point, new _linear.PointC({
				x: 0,
				y: size.height
			}));
		...
		key: 'RegularPolygon',
		value: function RegularPolygon(_ref8) {
			...
			var angle = Math.PI / 2 - angleStep;
			var point = (0, _linear.add2D)(center, new _linear.PointC({
				x: 0,
				y: radius
			}));
			...
			for (var i = 0; i < sides; i++) {
				angle += angleStep;
				point = (0, _linear.add2D)(center, new _linear.PointC({
		...
		value: function Ellipse(_ref9) {
			...
			var curves = [(0, _linear.arcToCubicBezier)(size.width, size.height, 0, 0.25), (0, _linear.arcToCubicBezier)(size.width, size.height, 0.25, 0.5), (0, _linear.arcToCubicBezier)(size.width, size.height, 0.5, 0.75), (0, _linear.arcToCubicBezier)(size.width, size.height, 0.75, 1)];

			if (size.height > size.width) {
				curves = curves.map(function (curve) {
					return curve.map(function (item) {
						var point = new _Node2.default(item);

						var _point$rotate = point.rotate(90, center),
						    x = _point$rotate.x,
						    y = _point$rotate.y;
			...
			result = result.moveTo((0, _linear.add2D)(center, curves[0][0]));

			curves.forEach(function (curve) {
				var _curve = _slicedToArray(curve, 4),
				    c1 = _curve[1],
				    c2 = _curve[2],
				    c3 = _curve[3];

				result = result.curveTo({
					c1: (0, _linear.add2D)(center, c1),
					c2: (0, _linear.add2D)(center, c2),
					c3: (0, _linear.add2D)(center, c3)
				});
			});
...
var cmap = __webpack_require__(17);
var cff = __webpack_require__(16);
var fvar = __webpack_require__(36);
var glyf = __webpack_require__(37);
var gpos = __webpack_require__(38);
var gsub = __webpack_require__(18);
var head = __webpack_require__(19);
var hhea = __webpack_require__(20);
var hmtx = __webpack_require__(21);
var kern = __webpack_require__(39);
var ltag = __webpack_require__(22);
var loca = __webpack_require__(40);
var maxp = __webpack_require__(23);
var _name = __webpack_require__(25);
var os2 = __webpack_require__(26);
...
var encoding = __webpack_require__(5);
var glyphset = __webpack_require__(8);
var parse = __webpack_require__(0);
var path = __webpack_require__(4);
...
exports.addToFonts = addToFonts;

var _opentype = __webpack_require__(13);
...
var Font = function () {
	function Font(aArgs) {
		...
		var notdef = new _Glyph2.default({
			name: '.notdef',
			unicode: 0,
			advanceWidth: 650
		});
		...
		if ((typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' && window.document && !document.fonts) {
	...
	_createClass(Font, [{
		key: 'addGlyph',
		value: function addGlyph(glyph) {
			return this.addGlyphs([glyph]);
		}
	}, {
		key: 'addGlyphs',
		value: function addGlyphs(glyphs) {
			var glyphMap = _extends({}, this.glyphMap);
			var charMap = _extends({}, this.charMap);
			var altMap = _extends({}, this.altMap);
			...
			glyphs.forEach(function (glyph) {
				...
				// and name are equal
				if (!charMap[glyph.ot.unicode] || glyph.name.length === 1 && glyph.name.charCodeAt(0) === glyph.ot.unicode) {
		...
		key: 'setSubset',
		value: function setSubset(set) {
			var subset = this.normalizeSubset(set);
		...
		key: 'normalizeSubset',
		value: function normalizeSubset(_set) {
			var _this = this;

			var setString = void 0;
			var setArrayNumber = void 0;
			var setArrayGlyph = [];
			var result = [];
			...
			if (_set === undefined) {
				setArrayGlyph = Object.keys(this.charMap).map(function (unicode) {
					return _this.charMap[unicode];
				});

				// convert string to array of chars
			} else if (setString) {
				setArrayNumber = setString.split('').map(function (e) {
			...
			if (setArrayNumber) {
				setArrayGlyph = setArrayNumber.filter(function (unicode) {
					return typeof unicode === 'number';
				}).map(function (unicode) {
					return _this.charMap[unicode.toString()];
				});
			}
			...
			result.forEach(function (glyph) {
				if (glyph && glyph._base) {
					var base = _this.charMap[glyph._base.toString()];
		...
		key: 'getGlyphSubset',
		value: function getGlyphSubset(_set) {
			return _set === undefined ? this.subset : this.normalizeSubset(_set);
		}
	}, {
		key: 'setAlternateFor',
		value: function setAlternateFor(unicode, glyphName) {
			var charMap = _extends({}, this.charMap);
  ...
  */
		...
		key: 'getSVGData',
		value: function getSVGData(set) {
			var result = this.getGlyphSubset(set).map(function (glyph) {
		...
		key: 'getOTCommands',
		value: function getOTCommands(set, shouldMerge) {
			return this.getOT({
				set: set,
		...
		key: 'getOT',
		value: function getOT(args) {
			var glyphs = this.getGlyphSubset(args && args.set).map(function (glyph) {

				var result = _extends({}, glyph.getOTCommands(), { ot: glyph.ot });
		...
		key: 'toArrayBuffer',
		value: function toArrayBuffer(otCommands) {
			var glyphs = otCommands.map(function (otCommand) {
				var result = new _opentype2.default.Glyph({
			...
			var otFont = new _opentype2.default.Font({
				familyName: this.ot.familyName,
				styleName: this.ot.styleName,
				ascender: this.ot.ascender,
				descender: this.ot.descender,
			...
			otFont.names.postScriptName.en = otFont.names.postScriptName.en.replace(/[^A-z]/g, '_');

			return otFont.toArrayBuffer();
		}
	}, {
		key: 'importOT',
		value: function importOT(otFont) {
			this.ot = otFont;

			for (var i = 0; i < otFont.glyphs.length; ++i) {
				var otGlyph = otFont.glyphs.get(i);
				var glyph = new _Glyph2.default({
					name: otGlyph.name,
...
var triggerDownload = function triggerDownload(arrayBuffer, filename) {
	...
	reader.readAsDataURL(new Blob([new DataView(arrayBuffer)], { type: 'font/opentype' }));
};

function download(arrayBuffer, name) {
	if ((typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' && window.document) {
		triggerDownload(arrayBuffer, name && name.family + ' ' + name.style);
	}
}

var fontMap = {};

function addToFonts(buffer, enFamilyName) {
	if ((typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' && window.document && document.fonts) {
		...
		var fontface = fontMap[enFamilyName] = new window.FontFace(enFamilyName, buffer);
...
var OutlineGroup = function () {
	function OutlineGroup() {
		var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { children: [] },
	...
	_createClass(OutlineGroup, [{
		...
		key: 'insertChild',
		value: function insertChild(index, child) {
			var children = [].concat(_toConsumableArray(this.children));
		...
		value: function getSVGData() {
			...
			this.children.forEach(function (outline) {
				outline.getSVGData(path);
			});
		...
		key: 'interpolate',
		value: function interpolate(outlineGroup0, outlineGroup1, coef) {
			var children = [];

			if (outlineGroup0.children.length === outlineGroup1.children.length) {
				for (var i = 0; i < outlineGroup0.children.length; i++) {
					var glyphElem0 = outlineGroup0.children[i];
					var glyphElem1 = outlineGroup1.children[i];

					if (glyphElem0 instanceof _Outline2.default && glyphElem1 instanceof _Outline2.default) {
						children.push(_Outline2.default.interpolate(glyphElem0, glyphElem1, coef));
					} else if (glyphElem0 instanceof OutlineGroup && glyphElem1 instanceof OutlineGroup) {
...
exports.addToFonts = exports.Node = exports.Path = exports.Outline = exports.Glyph = exports.Font = undefined;
...
exports.addToFonts = _Font.addToFonts;
